                ...
                <div class="mt-5">
                    <ul class="space-y-2">
                        @forelse ($eventss as $item)
                            <li class="border p-4 flex justify-between items-center rounded-lg shadow cursor-pointer  ">
                                ...
                                <div>
                                    <x-button class="hover:scale-95" sm color="emerald"
                                        href="{{ route('teacher.repository-view', ['id' => $item->repository_id]) }}"
                                        icon="eye" position="right" target="_blank">Open
                                        Repo</x-button>
                                </div>
                            </li>
                        @empty
